...
export class ApplicationstatechangeService {
  ...
  public getListApplicationByApplicant(id){
    return this.httpClient.get(this.apiURL + '/list-by-user/'+id);
  }
  public getListApplicationByJob(id){
    return this.httpClient.get(this.apiURL + '/list-by-job/'+id);
  }
  public getListApplicantHireByJob(id){
    return this.httpClient.get(this.apiURL +'/list-application-hire/'+ id)
  }
}
