...
@NgModule({
  declarations: [ApplicantprofileComponent, EditprofileComponent, WorkexperienceeditComponent, EducationeditComponent, SkilleditComponent, ApplicationlistComponent, ResumeComponent, SearchjobsComponent],
  imports: [
    CommonModule,
